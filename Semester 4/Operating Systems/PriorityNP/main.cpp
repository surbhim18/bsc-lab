...
void display_priorityNP_Schedule(Process *p, int n)
{
    cout<<"Process\tBurst Time\tArrival Time\tPriority\tStarting Time\tFinishing Time\n";
...
int main()
{
    ...
    display_priorityNP_Schedule(p,n);
    cout<<endl;
