...
int main()
{
    ...
    do{
        ...
        cout<<"11.Delete data at a position.\n";
        cout<<"12.Reverse the link list.\n";
        cout<<"13.Display the list.\n";
        cout<<"14.Display DLL.\n";
        cout<<"15.Exit.\n";
        cout<<"\n--------------------------------------------------------------------------";
        cout<<"\nEnter choice: ";
        ...
        switch(ch)
        {
            ...
            case 11:
            cout<<"\nEnter position at which data is to be deleted: ";
            cin>>data;
            try
            {
                element = listObj.deleteAtPos(data);
                cout<<"\nElement: "<<element;
            }
            catch(MyException& ex)
            {
